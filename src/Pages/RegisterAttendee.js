...
function RegisterAttendee() {
  ...
  let registerAttendee = async (e) => {
    e.preventDefault();
    try {
      await validateForm();
      set(ref(database, "Attendees/" + ID), {
        ID,
        cnic,
        Fname,
        Lname,
  ...
  return (
    <>
      <h3 className="bg-primary text-center text-white py-3">
        Register Attendee
      </h3>
      <div className="container mb-3">
        ...
        <Form>
          ...
          <Form.Group className="mb-3" controlId="formBasicAttending">
          ...
          <Button variant="primary" type="submit" onClick={registerAttendee}>
            Register Attendee
          </Button>
        </Form>
      </div>
